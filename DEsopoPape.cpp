...
/*
 ...
 It works for negative edges but not work for negative cycle.

 The algorithm performs usually quite fast. In most cases even
 faster than Dijkstra's algorithm. However there exist cases
...
void DEsopoPape(int v0, V<int>& Dist, V<int>& Pred){
    Dist.assign(n, Iinf);
    Dist[v0] = 0;
    V<int> Set(n, 2);
    deque<int> que;
